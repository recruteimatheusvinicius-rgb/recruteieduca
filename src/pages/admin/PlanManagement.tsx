      ...
      <div className="container-app py-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {plans.map((plan) => (
            <Card
              key={plan.id}
              className="relative overflow-hidden rounded-2xl shadow-card hover:shadow-hover transition-shadow"
            >
              <div className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0"
                    style={{ backgroundColor: `${plan.color || '#16a34a'}20` }}
                  >
                    <div
                ...
                <div className="flex gap-2">
                  <Button variant="secondary" size="sm" className="flex-1 rounded-xl font-semibold" onClick={() => openModal(plan)}>
                    <Edit2 size={16} />
                    Editar
                  </Button>
                  <Button
                  ...
                  {courses.map((course) => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-surface-500 dark:text-surface-400">{course.duration} • {course.category}</p>
                      </div>
                    </label>
                  ))}
                  {courses.length === 0 && (
